...
namespace TesterApp
{
    internal class Options
    {
        ...
        [Option('a', "cacert", Required = false, HelpText = "Optional path to a CA certificate used to verify Syslog server certificate when using TCP protocol")]
        public string CACertPath { get; set; }

        [Option('c', "certifcate", Required = false, HelpText = "Optional path to a certificate used to authenticate client for the syslog server using TCP protocol with TLS1.2 encryption")]
        public string CertificatePath { get; set; }
     
        [Option('w', "password", Required = false, HelpText = "Password for given Certificate")]
